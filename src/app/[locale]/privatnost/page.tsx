...
const C = {
  me: {
    ...
    sections: [
      ['Rukovalac podacima', 'Rukovalac vašim ličnim podacima je Hirin’ Hero Co d.o.o., PIB 03637689, sa sjedištem na adresi Oktobarske revolucije 86, Podgorica, Crna Gora (u daljem tekstu: „Agencija“). Za sva pitanja u vezi sa obradom podataka možete nam pisati na danilo365days@gmail.com.'],
      ...
      ['Vaša prava', 'U svakom trenutku imate pravo da zatražite: pristup svojim podacima, ispravku netačnih podataka, brisanje podataka („pravo na zaborav“), ograničenje obrade i opoziv saglasnosti. Zahtjev pošaljite na danilo365days@gmail.com — postupamo bez odlaganja, a najkasnije u roku od 15 dana.'],
  ...
  en: {
    ...
    sections: [
      ['Data Controller', 'The controller of your personal data is Hirin’ Hero Co d.o.o., PIB 03637689, Oktobarske revolucije 86, Podgorica, Montenegro (the “Agency”). For any questions regarding data processing, write to danilo365days@gmail.com.'],
      ...
      ['Your Rights', 'At any time you may request: access to your data, correction of inaccurate data, deletion (“right to be forgotten”), restriction of processing and withdrawal of consent. Send your request to danilo365days@gmail.com — we act without delay, and within 15 days at the latest.'],
